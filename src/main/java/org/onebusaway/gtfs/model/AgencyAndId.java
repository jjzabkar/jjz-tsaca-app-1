...
public class AgencyAndId implements Serializable, Comparable<AgencyAndId> {
	 ...
	 * @param agencyAndId
	 */
	public AgencyAndId(String agencyAndId) {
	 ...
	 * 
	 * @param value
	 *            id of the form "agencyId_entityId"
	 * @return an id object
	 */
   ...
   ****/
	...
	/**
	 * Given an {@link AgencyAndId} object, creates a string representation of the form "agencyId_entityId"
	 * 
	 * @param aid
	 *            an id object
